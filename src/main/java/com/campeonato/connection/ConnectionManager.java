...
public class ConnectionManager {
    ...
    public CampeonatoConnection getConnectionSeguridad() throws SQLException {
        return new CampeonatoConnection(
            abrirConexion(resolverDataSource(PropiedadesDB.getJndiSeguridad()))
        );
    }

    public CampeonatoConnection getConnectionCampeonato() throws SQLException {
        return new CampeonatoConnection(
            abrirConexion(resolverDataSource(PropiedadesDB.getJndiCampeonato()))
        );
    }

    public CampeonatoConnection getConnectionEstadisticas() throws SQLException {
        return new CampeonatoConnection(
            abrirConexion(resolverDataSource(PropiedadesDB.getJndiEstadisticas()))
        );
    }
    ...
    public CampeonatoConnection getConnectionTestSeguridad() throws SQLException {
        return new CampeonatoConnection(
            abrirConexionDriver(
                PropiedadesDB.getDriverUrlSeguridad(),
                PropiedadesDB.getDriverUsuarioSeguridad(),
                PropiedadesDB.getDriverClaveSeguridad()
            )
        );
    }
    ...
    public CampeonatoConnection getConnectionTestCampeonato() throws SQLException {
        return new CampeonatoConnection(
            abrirConexionDriver(
                PropiedadesDB.getDriverUrlCampeonato(),
                PropiedadesDB.getDriverUsuarioCampeonato(),
                PropiedadesDB.getDriverClaveCampeonato()
            )
        );
    }
    ...
    public CampeonatoConnection getConnectionTestEstadisticas() throws SQLException {
        return new CampeonatoConnection(
            abrirConexionDriver(
                PropiedadesDB.getDriverUrlEstadisticas(),
                PropiedadesDB.getDriverUsuarioEstadisticas(),
                PropiedadesDB.getDriverClaveEstadisticas()
            )
        );
    }
